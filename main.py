...
ROUND_DELAY = 3  # 3 ثواني بين الجولات
BET_OPTIONS = [10, 50, 100, 500, 1000, 5000]
INITIAL_BALANCE = 1000  # رصيد بداية لكل مستخدم جديد

# 50 نقطة تحطم مختلفة (مضاعفات)
CRASH_POINTS = [
    1.2, 1.5, 2.0, 0.5, 3.0, 1.8, 2.5, 0.3, 4.0, 1.3,
    2.2, 0.8, 5.0, 1.6, 2.8, 0.6, 6.0, 1.9, 3.2, 0.4,
    7.0, 2.1, 3.5, 0.2, 8.0, 2.3, 3.8, 0.1, 9.0, 2.4,
    4.0, 1.1, 10.0, 2.6, 4.2, 0.7, 12.0, 2.7, 4.5, 0.9,
    15.0, 2.9, 4.8, 1.4, 18.0, 3.1, 5.0, 0.0, 20.0, 50.0
]
